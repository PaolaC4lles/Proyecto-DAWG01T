...
calc.onclick = function () {
    if (kg.value !== "" && m.value !== "") {
        ...
        if (imcx <= 15) {
            ...
            document.getElementById("15oM").style.backgroundColor = "#A48A1D";
        } else if (imcx >= 15.00000001 && imcx <= 15.9) {
            lectura.innerHTML = "Delgadez severa";
            document.getElementById("DelgadezS").style.backgroundColor = "#969387";
        } else if (imcx >= 16 && imcx <= 18.4) {
            lectura.innerHTML = "Delgadez";
            document.getElementById("Delgadez").style.backgroundColor = "#1D93B9";
        } else if (imcx >= 18.5 && imcx <= 24.9) {
            lectura.innerHTML = "Peso Saludable";
            document.getElementById("pesoS").style.backgroundColor = "#02AB02";
